(function(){
  ...
  function consentShow(){
    if($('#consent')) return;
    var d=document.createElement('div'); d.className='consent glass'; d.id='consent'; d.setAttribute('role','dialog'); d.setAttribute('aria-label','Cookies');
    d.innerHTML='<p class="consent__txt" data-i18n="ck_txt">Na meranie návštevnosti používam Google Analytics a Google Tag Manager. Zapnú sa až s tvojím súhlasom.</p>'+
      '<div class="consent__btns"><button type="button" class="consent__ok" id="ckOk" data-i18n="ck_ok" data-hover>Súhlasím</button><button type="button" class="consent__no" id="ckNo" data-i18n="ck_no" data-hover>Odmietnuť</button><a class="consent__more mono" href="/ochrana-osobnych-udajov/#cookies" data-i18n="ck_more" data-hover>Viac o cookies</a></div>';
